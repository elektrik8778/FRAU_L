...
def greeting(user):
    text = f'''
*Привет, {user.first_name.strip()}, меня зовут Али!*

Мы в службе доставки "Лаваши" готовим вкуснейшую шаурму, турецкий пилав, лепешки пиде, пиццу и многое другое!

Я помогу тебе оформить заказ и быстро доставлю все блюда.

👇🏻 Чтобы добавить товары в корзину нажми кнопку "меню"
'''
    return text
